...
using JLGA.Architecture.VisualNovel.Parser;
using JLGA.Unity.VisualNovel.Listener;

namespace JLGA.Unity.VisualNovel.Parser
{
    public class VNParser : MonoBehaviour
    {
        ...
        public void SetVisualNovel(string fileLocation)
        {
            ...
            _script = new VNScript(scriptText.text);
        ...
        private static void _s_IntializeActionParser_SoundActions()
        {
            _s_actionParser.AddAction(new VNAction<Context, Result>(
                "Sound.Select",
                new VNBracketPair[] { _s_nameBracketPair },
        ...
        private static void _s_InitializeBracketsCallbacks()
        {
            ...
            _s_bracketsCallbacks.Add(_s_nameBracketPair.Left, (context, arg, errors) =>
            {
                if (context.Listeners.DisplaySelector.CurrentlySelected == null)
                {
            ...
            _s_bracketsCallbacks.Add(_s_dialogueBracketPair.Left, (context, arg, errors) =>
            {
                if (context.Listeners.DisplaySelector.CurrentlySelected == null)
                {
                    errors.Add(new VNError($"Display not selected {arg}.", VNError.EStatus.NonFatal, arg));
            ...
            _s_bracketsCallbacks.Add(_s_markerBracketPair.Left, (context, _, __) => Result.Continue);
            _s_bracketsCallbacks.Add(_s_commentBracketPair.Left, (context, _, __) => Result.Continue);
        }
